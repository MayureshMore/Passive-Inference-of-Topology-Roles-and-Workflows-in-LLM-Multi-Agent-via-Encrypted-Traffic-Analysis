...
DEPLOYMENTS: dict[str, dict] = {
    ...
    # Deployment C — independent framework (LangGraph StateGraph orchestrator).
    # Reuses A's specialists unchanged (label alignment); only the orchestration
    # engine differs.  Ports 8030-8033 so C runs back-to-back with A/B (8021 is
    # occupied by a system service on the primary testbed Mac).
    "langgraph": {
